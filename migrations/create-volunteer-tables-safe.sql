-- Migration: Create Volunteer Dashboard Tables (SAFE VERSION)
-- Description: Creates volunteers, event_registrations tables and complete_user_profiles view
-- Date: 2025-10-25
-- Note: This version drops existing tables to ensure clean state
...
DROP FUNCTION IF EXISTS create_volunteer_profile(UUID, TEXT, TEXT) CASCADE;
...
-- ============================================
CREATE FUNCTION create_volunteer_profile(
  user_id_param UUID,
  username_param TEXT,
  email_param TEXT
) RETURNS UUID AS $$
...
BEGIN
  ...
  RAISE NOTICE 'Tables created: volunteers, event_registrations';
  RAISE NOTICE 'View created: complete_user_profiles';
  RAISE NOTICE 'Function created: create_volunteer_profile()';
END $$;
